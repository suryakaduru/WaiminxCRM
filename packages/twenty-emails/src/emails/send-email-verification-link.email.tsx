...
export const SendEmailVerificationLinkEmail = ({
  ...
  const bodyId = isEmailUpdate
    ? 'We received a request to change the email address associated with your Waimin account. Click below to confirm this change.'
    : 'Thanks for registering for an account on Waimin! Before we get started, we just need to confirm that this is you. Click below to verify your email address.';
